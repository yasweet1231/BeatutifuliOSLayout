...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UserListTableCell *cell = [tableView dequeueReusableCellWithIdentifier:@"UserListTableCell" forIndexPath:indexPath];
    cell.nameLabel.text = @"new friend";
    cell.iconImg.image = [UIImage imageNamed:@"user2.png"];
